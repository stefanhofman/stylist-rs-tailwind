...
/// Tailwind `font-sans`; css `font-family: ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";`
pub fn font_sans() -> Style {
    Style::new(css!("font-family: ui-sans-serif, system-ui, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\";")).unwrap()
}

/// Tailwind `font-serif`; css `font-family: ui-serif, Georgia, Cambria, "Times New Roman", Times, serif;`
pub fn font_serif() -> Style {
    Style::new(css!("font-family: ui-serif, Georgia, Cambria, \"Times New Roman\", Times, serif;")).unwrap()
}
